    ...
    <div class="load-r">
      ...
      <div class="load-r-max-r">
        <svg height="140" width="140">
          <circle cx="70" cy="70" r="50" stroke="#00000014" stroke-width="8" fill="none" />
          <circle
            r="50"
            cx="70"
            cy="70"
            ...
            stroke-width="7"
            style="stroke-dashoffset: 249.92px;"
          />
        </svg>
        <div class="load-r-min-r">
          <svg height="100" width="100">
            <circle cx="50" cy="50" r="30" stroke="#00000014" stroke-width="8" fill="none" />
            <circle
              r="30"
              cx="50"
              cy="50"
